      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.containerr}>
          ...
          <Grid container >
            ...
            <Grid item md={6} style={{marginTop:"3%", marginLeftt:"-1%",paddingTop: "30px",paddingBottom:"30px",paddingLeft:"20px", borderRadius:"20px", backgroundColor:"white"}}>
              <Chart />
            </Grid>
            <Grid item md={6} style={{marginTop:"3%",paddingTop: "30px",paddingBottom:"30px",paddingLeft:"20px", borderRadius:"20px", backgroundColor:"white"}}>
              <Barchart />
            </Grid>
          </Grid>
          <Box pt={4} >
